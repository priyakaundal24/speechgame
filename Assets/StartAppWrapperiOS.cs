...
//			"Unity version      = " + Application.unityVersion);
	...
	[DllImport ("__Internal")]
	private static extern void _showAdWithAdTag(string adTag);
	...
	[DllImport ("__Internal")]
	private static extern void _setBannerAdTag(string adTag);
	...
	public static void showAdWithAdTag(string adTag)
	{
		// Call plugin only when running on real device
		if (Application.platform != RuntimePlatform.OSXEditor){
			checkInitilize();
			_showAdWithAdTag(adTag);
		}
	}
	...
	public static void setBannerAdTag(string adTag)
	{
		_setBannerAdTag(adTag);
	}
